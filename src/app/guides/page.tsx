...
export default function GuidesPage() {
  return (
    <main className="mx-auto max-w-7xl px-4 py-10">
      ...
      <section className="mt-10 grid gap-3 md:grid-cols-4" aria-label="Guide quick links">
        <Link href="/guides/beginner" className="content-card">Beginner guide</Link>
        <Link href="/guides/get-aura-fast" className="content-card">Get Aura fast</Link>
        <Link href="/guides/rebirth" className="content-card">Rebirth guide</Link>
        <Link href="/guides/train-aura" className="content-card">Train Aura</Link>
      </section>
