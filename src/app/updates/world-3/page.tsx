...
export default function World3UpdatePage() {
  return (
    <main className="mx-auto max-w-7xl px-4 py-10">
      ...
      <PageIntro eyebrow="Update status" title="Aura Per Click World 3" description="World 3 is verified from the current Roblox title, and the Roblox API shows a July 1, 2026 update timestamp. Exact unlocks, rewards, and world requirements still need checking before they are treated as final." />
      <AdsterraArticleTop />
      <section className="mt-10 grid gap-4 md:grid-cols-3">
        <ContentPanel><h2 className="text-xl font-bold text-white">Verified</h2><p className="mt-3 text-sm leading-6 text-white/66">The Roblox title includes a World 3 label, and Roblox metadata shows the game updated on July 1, 2026.</p></ContentPanel>
